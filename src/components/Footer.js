        ...
        <div className="row">
          ...
          <div className="widget col-md-4">
            ...
            <div className="widget-content">
              ...
              <p>قوالب تمهيد المجلات الإخبارية. تم تصميم هذا العرض التوضيحي خصيصًا لعرض استخدام السمة كموقع للمجلة. قم بزيارة صفحتنا الرئيسية لمزيد من العروض التوضيحية.</p>
              <address>
                ...
                </svg>Amphitheatre, Mountain View,<br></br>
